...
const DesktopTwoPage = () => {
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-copperplate gap-[54px] items-center justify-start mx-auto pb-[342px] w-full">
            ...
            <div className="flex sm:flex-1 flex-col items-start justify-start w-auto sm:w-full">
              <div className="flex flex-col items-start justify-start w-[455px] sm:w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-auto sm:w-full">
                  ...
                  <div className="bg-white-A700 border border-gray-200 border-solid flex flex-col items-start justify-start p-4 rounded-[16px] shadow-bs w-[455px] sm:w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <div className="border-b border-gray-100 border-solid flex flex-row gap-1 items-center justify-between py-2 w-full">
                        ...
                        <Button
                          className="cursor-pointer min-w-[90px] rounded-[14px] text-center text-sm"
                          color="red_50"
                          size="xs"
                          variant="fill"
                        >
