...
const DesktopTwelvePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-copperplate gap-[54px] items-center justify-start mx-auto pb-[162px] w-full">
        ...
        <div className="flex flex-col font-inter gap-[55px] items-start justify-start max-w-[1032px] mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-14 items-start justify-start max-w-[1032px] w-full">
            ...
            <div className="flex sm:flex-1 flex-col gap-6 items-center justify-start w-auto sm:w-full">
              ...
              <div className="bg-white-A700 border border-gray-200 border-solid flex flex-col gap-6 items-start justify-start p-4 rounded-[16px] shadow-bs1 w-[455px] sm:w-full">
                <div className="flex flex-col gap-4 items-start justify-start w-full">
                  ...
                  <div className="flex flex-row gap-2 items-start justify-start w-auto">
                    <Button
                      className="cursor-pointer font-medium min-w-[70px] rounded-[15px] text-center text-xs"
                      color="gray_900"
                      size="xs"
                      variant="fill"
                    >
                    ...
                    <Button
                      className="common-pointer cursor-pointer font-medium min-w-[58px] rounded-[15px] text-center text-xs"
              ...
              >
                ...
                <span className="text-gray-600 font-inter font-normal"> </span>
                <span className="text-gray-900 font-inter font-normal">
                  and
                </span>
                <span className="text-gray-600 font-inter font-normal"> </span>
