...
const DesktopFourteenPage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-copperplate gap-[52px] items-center justify-start mx-auto pb-[102px] w-full">
        ...
        <div className="flex flex-col font-inter gap-[57px] items-start justify-start max-w-[1032px] mx-auto md:px-5 w-full">
          <Button
          ...
          <div className="flex md:flex-col flex-row gap-14 items-start justify-start max-w-[1032px] w-full">
            ...
            <div className="flex sm:flex-1 flex-col gap-6 items-start justify-start w-auto sm:w-full">
              ...
              <div className="flex flex-col gap-4 items-start justify-start w-[455px] sm:w-full">
                ...
                >
                  <DesktopOneGuest className="bg-gray-50 border border-gray-200 border-solid flex sm:flex-1 flex-col gap-2 items-center justify-start p-4 rounded-[16px] shadow-bs w-[455px] sm:w-full" />
                  <DesktopFourteenDate className="bg-gray-50 border border-gray-200 border-solid flex sm:flex-1 flex-col gap-2 items-center justify-start p-4 rounded-[16px] shadow-bs w-[455px] sm:w-full" />
                </List>
                <DesktopFourteenColumnwhichtimesuits className="bg-white-A700 border border-gray-200 border-solid flex flex-col gap-4 items-start justify-end py-4 rounded-[16px] shadow-bs1 w-full" />
              </div>
            </div>
          </div>
        </div>
